        ...
        <div className='w-3/4 grid grid-cols-3 gap-4'>
            {/* <div className='card p-4 rounded bg-white space-y-3 text-start'>
                <div className=' w-full h-32 mx-auto rounded'>
                    <img src="../../../Asset/Rectangle 2.png" alt="" className='w-full h-full' />
                </div>
                <h2 className='text-[17px] font-semibold'>Introduction to C Programming</h2>
                <p className='text-sm font-normal text-[rgba(28,27,27,0.60)]'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                <div className='flex space-x-2'>
                    ...
                    <p className='text-base font-medium text-[rgba(28,27,27,0.60)]'>Price : 15000</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <p className='text-base font-medium text-[rgba(28,27,27,0.60)]'>Credit : 1hr</p>
                </div>
